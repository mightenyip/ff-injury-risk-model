#!/usr/bin/env python3
"""
Combine 2022, 2023, and 2024 season data into a final dataset.
"""
...
def combine_three_seasons():
    """Combine 2022, 2023, and 2024 season data."""
    print("Combining 2022, 2023, and 2024 Season Data")
    print("=" * 50)
    
    # Input files
    file_2022 = "data/processed_2022/2022_combined_data.csv"
    ...
    print(f"  ✅ Loaded {len(df_2022)} games from 2022")
    ...
    all_columns = set(df_2022.columns) | set(df_2023.columns) | set(df_2024.columns)
    ...
    output_file = os.path.join(output_dir, "three_season_injury_data.csv")
    combined_df.to_csv(output_file, index=False)
    
    print(f"\n✅ Successfully created three-season dataset!")
...
def main():
    """Main function."""
    final_df = combine_three_seasons()
    ...
    if final_df is not None:
        ...
        print(f"\nThis is a comprehensive dataset with 3 seasons of real NFL data!")
