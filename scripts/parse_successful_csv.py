#!/usr/bin/env python3
"""
Successful parser for PFR CSV files with all columns.
"""
...
def parse_successful_csv(file_path):
    ...
    try:
        ...
        # Convert to list and clean column names
...
def main():
    ...
    print("Parsing PFR Game Data - Successful Version")
    print("=" * 45)
    
    # Input and output directories
    input_dir = "data/weekly_raw"
    output_dir = "data/successful_game_data"
    ...
    for csv_file in csv_files:
        parsed_df = parse_successful_csv(csv_file)
    ...
    output_file = os.path.join(output_dir, "successful_game_data.csv")
