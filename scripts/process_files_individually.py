#!/usr/bin/env python3
"""
Process PFR CSV files individually and save them separately.
"""
...
def process_single_file(file_path, output_dir):
    """Process a single PFR CSV file and save it."""
    ...
    try:
        ...
        data_df = create_injury_indicators(data_df)
...
def main():
    """Main function to process all PFR data individually."""
    print("Processing PFR Game Data Individually")
    print("=" * 40)
    
    # Input and output directories
    input_dir = "data/weekly_raw"
    output_dir = "data/individual_processed"
    ...
    for csv_file in csv_files:
        processed_df = process_single_file(csv_file, output_dir)
    ...
    try:
        ...
        print(f"\n✅ Successfully processed all game data!")
