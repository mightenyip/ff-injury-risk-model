#!/usr/bin/env python3
"""
Working parser for PFR CSV files with all columns.
"""
...
def parse_working_csv(file_path):
    ...
    try:
        ...
        # Clean column names - convert to strings and handle NaN
        clean_column_names = []
...
def main():
    ...
    print("Parsing PFR Game Data - Working Version")
    print("=" * 45)
    
    # Input and output directories
    input_dir = "data/weekly_raw"
    output_dir = "data/working_game_data"
    ...
    for csv_file in csv_files:
        parsed_df = parse_working_csv(csv_file)
    ...
    output_file = os.path.join(output_dir, "working_game_data.csv")
    combined_df.to_csv(output_file, index=False)
    
    print(f"\n✅ Successfully parsed working game data!")
    ...
    if available_cols:
        ...
        print("No key columns found in the data")
