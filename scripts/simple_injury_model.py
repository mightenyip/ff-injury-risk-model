#!/usr/bin/env python3
"""
Simple injury risk model using the cleaned three-season dataset.
"""
...
def select_features(df):
    ...
    # Define feature columns (using existing features from the dataset)
    feature_columns = [
        # Basic game stats
        'Att', 'Yds', 'TD', 'Rec', 'Y/A', 'Tgt', 'Y/R', 'Ctch%',
        
        # Workload features (already in dataset)
        'touches_prev', 'touches_prev_2', 'touches_prev_3',
        'career_touches_prior', 'prior_multiweek_prev',
        
        # New simple features
        'touches_per_game', 'yards_per_touch', 'touchdown_rate',
        'late_season', 'games_played', 'age'
    ]
...
def main():
    ...
    print("Building NFL Injury Risk Model (Simple Version)")
    print("=" * 60)
