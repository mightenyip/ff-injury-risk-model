#!/usr/bin/env python3
"""
Simple 2023 data processor that preserves original column names.
"""
...
def parse_2023_simple(filepath):
    """Parse 2023 CSV with simple, direct approach."""
    try:
...
def process_2023_simple():
    """Process all 2023 CSV files with simple parsing."""
    print("Processing 2023 Season Data (Simple)")
    print("=" * 40)
    ...
    for csv_file in csv_files:
        ...
        parsed_df = parse_2023_simple(csv_file)
