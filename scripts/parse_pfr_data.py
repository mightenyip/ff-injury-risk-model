#!/usr/bin/env python3
"""
Parse PFR data properly by handling the multi-level structure.
"""
...
def parse_pfr_csv(file_path):
    """Parse a PFR CSV file with the correct structure."""
    ...
    try:
        ...
        # The structure is:
        # Row 0: Column group headers (Rushing, Receiving, etc.)
...
def main():
    ...
    print("Parsing PFR Game Data")
    print("=" * 30)
    
    # Input and output directories
    input_dir = "data/weekly_raw"
    output_dir = "data/parsed_game_data"
    ...
    for csv_file in csv_files:
        parsed_df = parse_pfr_csv(csv_file)
    ...
    output_file = os.path.join(output_dir, "parsed_game_data.csv")
    combined_df.to_csv(output_file, index=False)
    
    print(f"\n✅ Successfully parsed game data!")
