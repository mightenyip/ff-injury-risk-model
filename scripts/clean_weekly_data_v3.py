#!/usr/bin/env python3
"""
Clean and restructure the weekly game log data from PFR - Version 3.
This script properly handles the actual CSV structure from the bookmarklet.
"""
...
def main():
    ...
    print("Cleaning Weekly Game Log Data - Version 3")
    print("=" * 50)
    ...
    # Save cleaned data
    output_file = os.path.join(output_dir, "cleaned_weekly_data_v3.csv")
